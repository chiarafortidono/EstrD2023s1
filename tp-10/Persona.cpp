...
Persona consPersona(string nombre, int edad) { // Devuelve el nombre de una persona.
...
void crecer(Persona p) { // Aumenta en uno la edad de la persona.
    p->edad++;
};

void cambioDeNombre(string nombre, Persona p) { // Modifica el nombre una persona.
    p->nombre=nombre;
};
